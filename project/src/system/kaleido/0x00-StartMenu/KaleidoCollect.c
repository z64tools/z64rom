...
void KaleidoScope_DrawQuestStatus(PlayState* play, GraphicsContext* gfxCtx) {
    ...
    if (
        (!pauseCtx->unk_1E4 || (pauseCtx->unk_1E4 == 5) || (pauseCtx->unk_1E4 == 8)) &&
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if ((pauseCtx->state == 6) && (pauseCtx->unk_1E4 == 0) && (pauseCtx->cursorSpecialPos == 0)) {
                ...
                if (
                    CHECK_BTN_ALL(input->press.button, BTN_A) && (sp216 >= QUEST_SONG_MINUET) &&
    ...
    if (pauseCtx->state == 6) {
        ...
        if (pauseCtx->unk_1E4 == 2) {
            ...
            for (sp218 = sp21A, phi_s3 = 0; phi_s3 < sp226; phi_s3++, sp21A += 4) {
                ...
                gDPLoadTextureBlock(
                    POLY_OPA_DISP++,
                    D_8082A130[gOcarinaSongButtons[sp224].buttonsIndex[phi_s3]],
                    G_IM_FMT_IA,
                    G_IM_SIZ_8b,
                    16,
                    16,
            ...
            if (pauseCtx->unk_1E4 != 8) {
                ...
                if (pauseCtx->ocarinaStaff->pos != 0) {
                    if (D_8082A11C == (pauseCtx->ocarinaStaff->pos - 1)) {
                        if (
                            (pauseCtx->ocarinaStaff->buttonIndex >= OCARINA_BTN_A) &&
        ...
        for (phi_s3 = 0, sp218 = 0, sp21A = 0; phi_s3 < 2; phi_s3++) {
            ...
            for (sp21A = 0; sp21A < 3; sp21A++, sp218 += 4) {
                if ((sp21A >= 2) || (sp208[sp21A] != 0) || (phi_s0 != 0)) {
                    gDPLoadTextureBlock(
                        POLY_OPA_DISP++,
                        ((u8*)gCounterDigit0Tex + (8 * 16 * sp208[sp21A])),
                        G_IM_FMT_I,
                        G_IM_SIZ_8b,
                        8,
                        16,
