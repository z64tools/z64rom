...
Vtx D_80811BB0[] = {
    ...
    VTX(-38, 72,  0, 1792, 0,   255, 255, 255, 255),
    VTX(-94, 56,  0, 0,    512, 255, 255, 255, 255),
    VTX(-38, 56,  0, 1792, 512, 255, 255, 255, 255),
    VTX(-96, -48, 0, 0,    0,   255, 255, 255, 255),
    VTX(-52, -48, 0, 1408, 0,   255, 255, 255, 255),
    VTX(-96, -64, 0, 0,    512, 255, 255, 255, 255),
    VTX(-52, -64, 0, 1408, 512, 255, 255, 255, 255),
    VTX(-48, -48, 0, 0,    0,   255, 255, 255, 255),
    VTX(-4,  -48, 0, 1408, 0,   255, 255, 255, 255),
    VTX(-48, -64, 0, 0,    512, 255, 255, 255, 255),
    VTX(-4,  -64, 0, 1408, 512, 255, 255, 255, 255),
    VTX(0,   -48, 0, 0,    0,   255, 255, 255, 255),
    VTX(28,  -48, 0, 896,  0,   255, 255, 255, 255),
    VTX(0,   -64, 0, 0,    512, 255, 255, 255, 255),
    VTX(28,  -64, 0, 896,  512, 255, 255, 255, 255),
    VTX(32,  -48, 0, 0,    0,   255, 255, 255, 255),
    VTX(60,  -48, 0, 896,  0,   255, 255, 255, 255),
    VTX(32,  -64, 0, 0,    512, 255, 255, 255, 255),
    VTX(60,  -64, 0, 896,  512, 255, 255, 255, 255),
    VTX(64,  -48, 0, 0,    0,   255, 255, 255, 255),
    VTX(108, -48, 0, 1408, 0,   255, 255, 255, 255),
    VTX(64,  -64, 0, 0,    512, 255, 255, 255, 255),
    VTX(108, -64, 0, 1408, 512, 255, 255, 255, 255),
};
Vtx D_80811D30[] = {
    VTX(-94,  72,  0, 0,    0,   255, 255, 255, 255),
    VTX(34,   72,  0, 4096, 0,   255, 255, 255, 255),
    VTX(-94,  56,  0, 0,    512, 255, 255, 255, 255),
    VTX(34,   56,  0, 4096, 512, 255, 255, 255, 255),
    VTX(-100, 44,  0, 0,    0,   255, 255, 255, 255),
    VTX(-36,  44,  0, 2048, 0,   255, 255, 255, 255),
    VTX(-100, 28,  0, 0,    512, 255, 255, 255, 255),
    VTX(-36,  28,  0, 2048, 512, 255, 255, 255, 255),
    VTX(-100, 4,   0, 0,    0,   255, 255, 255, 255),
    VTX(-36,  4,   0, 2048, 0,   255, 255, 255, 255),
    VTX(-100, -12, 0, 0,    512, 255, 255, 255, 255),
    VTX(-36,  -12, 0, 2048, 512, 255, 255, 255, 255),
    VTX(-100, -36, 0, 0,    0,   255, 255, 255, 255),
    VTX(28,   -36, 0, 4096, 0,   255, 255, 255, 255),
    VTX(-100, -52, 0, 0,    512, 255, 255, 255, 255),
    VTX(28,   -52, 0, 4096, 512, 255, 255, 255, 255),
};
Vtx D_80811E30[] = {
    VTX(-94,  72,  0, 0,    0,   255, 255, 255, 255),
    VTX(34,   72,  0, 4096, 0,   255, 255, 255, 255),
    ...
    VTX(-36,  28,  0, 2048, 512, 255, 255, 255, 255),
    VTX(-100, 4,   0, 0,    0,   255, 255, 255, 255),
    VTX(44,   4,   0, 4608, 0,   255, 255, 255, 255),
    VTX(-100, -12, 0, 0,    512, 255, 255, 255, 255),
    VTX(44,   -12, 0, 4608, 512, 255, 255, 255, 255),
    VTX(-100, -36, 0, 0,    0,   255, 255, 255, 255),
    VTX(28,   -36, 0, 4096, 0,   255, 255, 255, 255),
    VTX(-100, -52, 0, 0,    512, 255, 255, 255, 255),
    VTX(28,   -52, 0, 4096, 512, 255, 255, 255, 255),
...
Vtx D_80811F30[] = {
    VTX(-100, 26,  0, 0,    0,   255, 255, 255, 255),
    VTX(-52,  26,  0, 1536, 0,   255, 255, 255, 255),
    VTX(-100, 10,  0, 0,    512, 255, 255, 255, 255),
    VTX(-52,  10,  0, 1536, 512, 255, 255, 255, 255),
    VTX(-48,  26,  0, 0,    0,   255, 255, 255, 255),
    VTX(0,    26,  0, 1536, 0,   255, 255, 255, 255),
    VTX(-48,  10,  0, 0,    512, 255, 255, 255, 255),
    VTX(0,    10,  0, 1536, 512, 255, 255, 255, 255),
    VTX(4,    26,  0, 0,    0,   255, 255, 255, 255),
    VTX(52,   26,  0, 1536, 0,   255, 255, 255, 255),
    VTX(4,    10,  0, 0,    512, 255, 255, 255, 255),
    VTX(52,   10,  0, 1536, 512, 255, 255, 255, 255),
    VTX(56,   26,  0, 0,    0,   255, 255, 255, 255),
    VTX(104,  26,  0, 1536, 0,   255, 255, 255, 255),
    VTX(56,   10,  0, 0,    512, 255, 255, 255, 255),
    VTX(104,  10,  0, 1536, 512, 255, 255, 255, 255),
    VTX(-100, -14, 0, 0,    0,   255, 255, 255, 255),
    VTX(-52,  -14, 0, 1536, 0,   255, 255, 255, 255),
    VTX(-100, -30, 0, 0,    512, 255, 255, 255, 255),
    VTX(-52,  -30, 0, 1536, 512, 255, 255, 255, 255),
    VTX(-48,  -14, 0, 0,    0,   255, 255, 255, 255),
    VTX(0,    -14, 0, 1536, 0,   255, 255, 255, 255),
    VTX(-48,  -30, 0, 0,    512, 255, 255, 255, 255),
    VTX(0,    -30, 0, 1536, 512, 255, 255, 255, 255),
    VTX(-100, -54, 0, 0,    0,   255, 255, 255, 255),
    VTX(-4,   -54, 0, 3072, 0,   255, 255, 255, 255),
    VTX(-100, -70, 0, 0,    512, 255, 255, 255, 255),
    VTX(-4,   -70, 0, 3072, 512, 255, 255, 255, 255),
    VTX(-4,   -54, 0, 0,    0,   255, 255, 255, 255),
    VTX(92,   -54, 0, 3072, 0,   255, 255, 255, 255),
    VTX(-4,   -70, 0, 0,    512, 255, 255, 255, 255),
    VTX(92,   -70, 0, 3072, 512, 255, 255, 255, 255),
};
Vtx D_80812130[] = {
    VTX(-100, 26,  0, 0,    0,   255, 255, 255, 255),
    VTX(-52,  26,  0, 1536, 0,   255, 255, 255, 255),
    ...
    VTX(104,  10,  0, 1536, 512, 255, 255, 255, 255),
    VTX(-100, -14, 0, 0,    0,   255, 255, 255, 255),
    VTX(-20,  -14, 0, 2560, 0,   255, 255, 255, 255),
    VTX(-100, -30, 0, 0,    512, 255, 255, 255, 255),
    VTX(-20,  -30, 0, 2560, 512, 255, 255, 255, 255),
    VTX(-16,  -14, 0, 0,    0,   255, 255, 255, 255),
    VTX(64,   -14, 0, 2560, 0,   255, 255, 255, 255),
    VTX(-16,  -30, 0, 0,    512, 255, 255, 255, 255),
    VTX(64,   -30, 0, 2560, 512, 255, 255, 255, 255),
    VTX(-100, -54, 0, 0,    0,   255, 255, 255, 255),
    VTX(-4,   -54, 0, 3072, 0,   255, 255, 255, 255),
    VTX(-100, -70, 0, 0,    512, 255, 255, 255, 255),
    VTX(-4,   -70, 0, 3072, 512, 255, 255, 255, 255),
...
void* sNameLabelTextures[] = { &gFileSelNameENGTex, &gFileSelNameENGTex, &gFileSelNameFRATex };
...
void FileSelect_SetNameEntryVtx(GameState* thisx) {
    ...
    gDPLoadTextureBlock(
        POLY_OPA_DISP++,
        sNameLabelTextures[gSaveContext.language],
        G_IM_FMT_IA,
        G_IM_SIZ_8b,
        56,
        16,
    ...
    for (phi_t1 = 0; phi_t1 < 2; phi_t1++, phi_s0 += 4) {
        ...
        gDPLoadTextureBlock(
            POLY_OPA_DISP++,
            sBackspaceEndTextures[gSaveContext.language][phi_t1],
            G_IM_FMT_IA,
            G_IM_SIZ_16b,
            sBackspaceEndWidths[phi_t1],
            16,
            0,
            G_TX_NOMIRROR | G_TX_WRAP,
            G_TX_NOMIRROR | G_TX_WRAP,
...
void FileSelect_DrawNameEntry(GameState* thisx) {
    ...
    if (
        (this->kbdButton == FS_KBD_BTN_HIRA) || (this->kbdButton == FS_KBD_BTN_KATA) ||
        ...
        if (CHECK_BTN_ALL(input->press.button, BTN_START)) {
            ...
            if (this->charPage <= FS_CHAR_PAGE_ENG) {
                if (this->kbdY != 5) {
                    ...
                    FileSelect_DrawCharacter(
                        this->state.gfxCtx,
                        font->fontBuf + D_808123F0[this->charIndex] * FONT_CHAR_TEX_SIZE,
                        0
                    );
...
void FileSelect_DrawOptionsImpl(GameState* thisx) {
    s16 cursorPrimRed = 255;
    s16 cursorPrimGreen = 255;
    s16 cursorPrimBlue = 255;
    s16 cursorEnvRed = 0;
    s16 cursorEnvGreen = 0;
    s16 cursorEnvBlue = 0;
    s16 cursorPulseDir = 1;
    s16 cursorFlashTimer = 20;
    ...
    for (i = 0, vtx = 0; i < 4; i++, vtx += 4) {
        gDPLoadTextureBlock(
            POLY_OPA_DISP++,
            gOptionsMenuHeaders[i].texture[gSaveContext.language],
            G_IM_FMT_IA,
            G_IM_SIZ_8b,
            gOptionsMenuHeaders[i].width[gSaveContext.language],
            gOptionsMenuHeaders[i].height,
            0,
            G_TX_NOMIRROR | G_TX_WRAP,
            G_TX_NOMIRROR | G_TX_WRAP,
            G_TX_NOMASK,
    ...
    for (i = 0, vtx = 0; i < 4; i++, vtx += 4) {
        ...
        gDPLoadTextureBlock(
            POLY_OPA_DISP++,
            gOptionsMenuSettings[i].texture[gSaveContext.language],
            G_IM_FMT_IA,
            G_IM_SIZ_8b,
            gOptionsMenuSettings[i].width[gSaveContext.language],
            gOptionsMenuHeaders[i].height,
            0,
            G_TX_NOMIRROR | G_TX_WRAP,
            G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gSPMatrix(
        POLY_OPA_DISP++,
        Matrix_NewMtx(this->state.gfxCtx, "../z_file_nameset_PAL.c", 1009),
    ...
    gSPMatrix(
        POLY_OPA_DISP++,
        Matrix_NewMtx(this->state.gfxCtx, "../z_file_nameset_PAL.c", 1021),
        G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW
    );
    ...
    gSPMatrix(
        POLY_OPA_DISP++,
        Matrix_NewMtx(this->state.gfxCtx, "../z_file_nameset_PAL.c", 1033),
        G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW
    );
